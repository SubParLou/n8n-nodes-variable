  ...
  description: INodeTypeDescription = {
    ...
    properties: [
      // ── Operation ─────────────────────────────────────────────────────────
      {
        ...
        options: [
          { name: 'Set Variable', value: 'set', action: 'Set a variable', description: 'Create or update a variable', icon: 'file:variable.svg' },
          { name: 'Get Variable', value: 'get', action: 'Get a variable', description: 'Retrieve a variable value', icon: 'file:variable.svg' },
          { name: 'Delete Variable', value: 'delete', action: 'Delete a variable', description: 'Remove a variable', icon: 'file:variable.svg' },
          { name: 'Has Variable', value: 'has', action: 'Check if a variable exists', description: 'Returns true/false if a variable exists', icon: 'file:variable.svg' },
          { name: 'List Variables', value: 'list', action: 'List variables', description: 'List all variables in a namespace', icon: 'file:variable.svg' },
          { name: 'Clear Variables', value: 'clear', action: 'Clear all variables', description: 'Remove all variables in a namespace', icon: 'file:variable.svg' },
          { name: 'Increment Variable', value: 'increment', action: 'Increment a variable', description: 'Add a number to a numeric variable', icon: 'file:variable.svg' },
          { name: 'Decrement Variable', value: 'decrement', action: 'Decrement a variable', description: 'Subtract a number from a numeric variable', icon: 'file:variable.svg' },
          { name: 'Append to Array', value: 'appendToArray', action: 'Append to an array variable', description: 'Push a value onto an array variable', icon: 'file:variable.svg' },
          { name: 'Merge Object', value: 'mergeObject', action: 'Merge into an object variable', description: 'Merge a JSON object into an object variable', icon: 'file:variable.svg' },
          { name: 'Toggle Boolean', value: 'toggleBoolean', action: 'Toggle a boolean variable', description: 'Flip a boolean variable between true and false', icon: 'file:variable.svg' },
        ],
        default: 'set',
      },
